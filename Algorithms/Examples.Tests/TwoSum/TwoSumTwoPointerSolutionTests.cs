...
{
    [TestClass]
    public class TwoSumTwoPointerSolutionTests
    {
        private readonly TwoSumTwoPointerSolution _solution;

        public TwoSumTwoPointerSolutionTests()
        {
            _solution = new TwoSumTwoPointerSolution();
        }
